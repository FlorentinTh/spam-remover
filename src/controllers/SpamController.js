...
class SpamController {
  ...
  async createSpam(spam) {
    ...
    const query = `INSERT INTO ${TABLE}(time, email, ip, hostname, city, region, country, location_latitude, location_longitude, organization, is_email_valid)
